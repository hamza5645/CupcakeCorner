...
class Order: ObservableObject, Codable {
    enum CodingKeys: CodingKey {
        case type, quantity, extraFrosting, addSprinkles, addMurshmello, name, streetAddress, city, zip
    }
    ...
    func encode(to encoder: Encoder) throws {
        ...
        try container.encode(addMurshmello, forKey: .addMurshmello)
    ...
    required init(from decoder: Decoder) throws {
        ...
        addMurshmello = try container.decode(Bool.self, forKey: .addMurshmello)
